...
public class Spiel {
  // Attribute
  private ArrayList<Spieler> spieler = new ArrayList<>(); // damit mehr als zwei Spieler mitspielen können (theoretisch beliebig viele)
  ...
  public void zug() {
    ...
    String eingabe = eingabeLeser.next(); // Auf String-Eingabe warten und zurückgeben
